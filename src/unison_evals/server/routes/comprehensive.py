...
Each directory contains one JSON file per (track, dataset, system) combo plus an
optional summary.json with aggregated metrics.
...
def _load_comprehensive_group(comp_dir: Path) -> dict[str, Any]:
    ...
    # Prefer summary.json if it exists.
